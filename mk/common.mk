...
$(BITFILE): $(VSOURCE) $(VHDSOURCE) $(CONSTRAINTS) build/$(PROJECT).prj build/$(PROJECT).scr
	@mkdir -p build
...
prog: $(BITFILE)
	$(PAPILIO_PROG_EXE) -v -f $(BITFILE)
endif

#
# program spi flash
#
ifeq ($(PROGRAMMER), papilio-prog-spi)
prog: $(BITFILE)
	$(PAPILIO_PROG_EXE) -v -f $(BITFILE) -b $(mkfile_dir)/share/papilio-prog/bitfiles/$(PAPILIO_PROG_SPI_BITFILE) -sa -r
endif
